...
pub use implementation::{
    ...
    merge_dir_pair, photos_pixel_identical, protect_preview, prune_expired_trash, query_groups,
    recycle_dir_keep_one, restore, restore_batch, restore_to, verify_photo_pairs,
